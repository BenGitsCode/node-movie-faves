...
function urlencoded(options){
  ...
  var limit = typeof options.limit !== 'number'? bytes(options.limit || '100kb')
    : options.limit;
  ...
  var queryparse = extended? extendedparser(options)
...
function extendedparser(options) {
  var parameterLimit = options.parameterLimit !== undefined? options.parameterLimit
    : 1000;
  var parse = parser('qs');
